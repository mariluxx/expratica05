    ...
    while True:
        ...
        for evento in pygame.event.get():
            if evento.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
            # Captura asa teclas para mover a cobrinha 
            if evento.type == pygame.KEYDOWN:
                if evento.kay == pygame.K_LEFT and x_velocidade == 0:
                    x_velocidade = tamanho_celula
                    y_velocidade = 0
                elif evento.kay == pygame.K_RIGHT and x_velocidade == 0:
                    x_velocidade = tamanho_celula 
                    y_velocidade = 0
                elif evento.kay == pygame.K_UP and y_velocidade == 0:
                    y_velocidade = tamanho_celula
                    x_velocidade = 0
                elif evento.kay == pygame.K_DOWN and y_velocidade == 0:
                    y_velocidade = tamanho_celula
                    x_velocidade = 0
        ...
        # Detecta colisão com as bordas ou com o própio corpo
